  ...
  const MentorRow = ({ index, style }: RowComponentProps) => {
    ...
    return (
      <button
        ...
        className={`flex w-full items-center justify-between gap-2 border-b border-border/40 px-3 text-left transition-colors ${active ? "bg-secondary/15" : "hover:bg-muted/40"
          }`}
      >
      ...
      <div className="rounded-2xl bg-[#0F1729] p-6 text-white">
        <div className="flex items-start justify-between gap-3 flex-wrap">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-lg bg-white px-3 py-2 text-xs font-bold text-[#1d2026] hover:bg-white/90"
          >
          ...
          <section className="rounded-xl border border-border bg-card">
            <div className="flex items-center justify-between border-b border-border p-4">
              ...
              <button
                ...
                className="flex items-center gap-1.5 rounded-lg bg-[#1d2026] px-3 py-1.5 text-xs font-semibold text-white hover:bg-[#1d2026]/90"
              >
