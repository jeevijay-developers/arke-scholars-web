...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      compete_matches: {
        Row: {
          ...
          player1_target_exam: string | null
          ...
          player2_target_exam: string | null
          question_ids: string[]
      ...
      content_items: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "content_items_test_id_fkey"
            columns: ["test_id"]
            isOneToOne: false
      ...
      course_favourites: {
        ...
        Relationships: [
          {
            foreignKeyName: "course_favourites_course_id_fkey"
            columns: ["course_id"]
            isOneToOne: false
            referencedRelation: "courses"
            referencedColumns: ["id"]
      ...
      questions: {
        Row: {
          ...
          match_col1: Json | null
          match_col2: Json | null
      ...
      test_questions: {
        ...
        Relationships: [
          {
            foreignKeyName: "test_questions_bank_question_id_fkey"
    ...
    Functions: {
      ...
      increment_player1_answers: {
        Args: { match_id: string }
        Returns: undefined
      }
      increment_player1_score: {
        Args: { delta: number; match_id: string }
        Returns: undefined
      }
      increment_player2_answers: {
        Args: { match_id: string }
        Returns: undefined
      }
      ...
      try_claim_opponent: {
        Args: { p_my_id: string; p_opp_id: string }
        Returns: boolean
      }
